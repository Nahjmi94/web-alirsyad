    ...
    <div className="flex flex-col min-h-screen bg-transparent text-slate-100 pb-20 overflow-hidden">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-10">
          {[
            { id: '1', judul: "LDKS OSIS SMP Al-Irsyad", desc: "Melatih kepemimpinan dan manajemen organisasi.", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Kegiatan+SMP+1" },
            { id: '2', judul: "Ekskul Robotik & Coding", desc: "Merakit dan memprogram modul robotik dasar.", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Kegiatan+SMP+2" },
            { id: '3', judul: "Muhadharah (Pidato 3 Bahasa)", desc: "Latihan public speaking Arab, Inggris, dan Indonesia.", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Kegiatan+SMP+3" }
          ].map((item, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 200}>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-10">
          {[
            { id: '1', juara: "Medali Emas OSN IPA Terpadu", event: "Tingkat Provinsi Jawa Tengah 2026", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Prestasi+SMP+1" },
            { id: '2', juara: "Juara 1 English Story Telling", event: "National English Competition 2026", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Prestasi+SMP+2" },
            { id: '3', juara: "Juara Umum Pramuka Penggalang", event: "Jambore Cabang Kota Pekalongan 2026", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Prestasi+SMP+3" }
          ].map((item, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 200}>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full text-center">
        ...
        <RevealOnScroll delay={800}>
          <Link href="/smp/pengajar" className="inline-flex items-center gap-3 px-10 py-4 rounded-2xl bg-amber-400 hover:bg-amber-300 text-emerald-950 text-xl font-black transition-all duration-300 shadow-xl hover:-translate-y-1">
          ...
          <div className="bg-[#071E16]/90 backdrop-blur-md border border-emerald-700/50 rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="flex justify-between items-center border-b border-emerald-800/60 pb-5 hover:text-amber-400 transition-colors group cursor-default">
                ...
                <span className="font-black text-amber-400 text-2xl sm:text-3xl">Rp 750.000</span>
              </div>
              <div className="flex justify-between items-center border-b border-emerald-800/60 pb-5 hover:text-amber-400 transition-colors group cursor-default">
