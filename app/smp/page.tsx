    ...
    <div className="flex flex-col min-h-screen bg-[#071E16] text-slate-100 pb-20 overflow-hidden">
      ...
      <section className="relative pt-12 pb-10 px-6 text-center">
        <RevealOnScroll delay={100}>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-bold mb-6 tracking-widest shadow-inner">USIA 13 - 15 TAHUN</div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 drop-shadow-md tracking-tight">SMP Al-Irsyad <br /> Pekalongan</h1>
          <p className="text-emerald-100/70 max-w-2xl mx-auto leading-relaxed text-lg font-light">Membentuk generasi pemimpin yang bertaqwa, berwawasan global, unggul dalam sains dan teknologi, serta berakhlakul karimah.</p>
        </RevealOnScroll>
      </section>
        ...
        <RevealOnScroll delay={200}>
          <div className="bg-[#052e20]/40 backdrop-blur-sm border border-emerald-800/40 rounded-3xl p-8 sm:p-10 shadow-2xl relative flex flex-col md:flex-row gap-8 items-center hover:border-amber-400/30 transition-colors">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-1">Ustadz Fauzan, M.Pd</h2>
              <p className="text-amber-400 text-sm font-medium mb-4">- Kepala SMP Al-Irsyad -</p>
              <p className="text-emerald-100/80 leading-relaxed text-sm font-light text-justify">"Usia SMP adalah fase pencarian jati diri. Kami mendampingi mereka dengan pendidikan karakter islami yang kuat dipadukan dengan kecakapan abad 21 agar siap menjadi agen perubahan di masa depan."</p>
            </div>
          </div>
        </RevealOnScroll>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            { judul: "Video Profil SMP", desc: "Fasilitas lab, kurikulum unggulan, dan kegiatan OSIS.", thumbnail: "https://placehold.co/600x340/041a12/fbbf24?text=Video+Profil+SMP" },
            { judul: "Video Kegiatan Siswa", desc: "Keseruan ekstrakurikuler dan event SMP Al-Irsyad.", thumbnail: "https://placehold.co/600x340/041a12/fbbf24?text=Video+Kegiatan" }
          ].map((vid, i) => (
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
          {[
            { id: '1', judul: "LDKS OSIS", desc: "Melatih kepemimpinan dan manajemen organisasi.", foto: "https://placehold.co/600x400/064e3b/fbbf24?text=Kegiatan+SMP+1" },
            { id: '2', judul: "Ekskul Robotik", desc: "Merakit dan memprogram robot dasar.", foto: "https://placehold.co/600x400/064e3b/fbbf24?text=Kegiatan+SMP+2" },
            { id: '3', judul: "Muhadharah (Pidato)", desc: "Latihan public speaking 3 bahasa.", foto: "https://placehold.co/600x400/064e3b/fbbf24?text=Kegiatan+SMP+3" }
          ].map((item, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 200}>
              <Link href={`/smp/kegiatan/${item.id}`} className="group overflow-hidden rounded-3xl border border-emerald-800/50 hover:border-amber-400/50 hover:-translate-y-2 transition-all duration-500 bg-[#041a12] cursor-pointer flex flex-col h-full block">
        ...
        <div className="text-center"><Link href="/smp/kegiatan" className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl border border-emerald-600/50 text-emerald-300 hover:text-emerald-950 hover:bg-amber-400 font-bold transition-all shadow-sm">Lihat Semua Kegiatan <span>→</span></Link></div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
          {[
            { id: '1', juara: "Emas OSN IPA", event: "Tingkat Provinsi Jawa Tengah", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Prestasi+SMP+1" },
            { id: '2', juara: "Juara 1 Story Telling", event: "English Competition 2026", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Prestasi+SMP+2" },
            { id: '3', juara: "Juara Umum Pramuka", event: "Jambore Cabang Pekalongan", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Prestasi+SMP+3" }
          ].map((item, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 200}>
              <Link href={`/smp/prestasi/${item.id}`} className="group overflow-hidden rounded-3xl border border-emerald-800/50 hover:border-amber-400/50 hover:-translate-y-2 transition-all duration-500 bg-[#041a12] cursor-pointer flex flex-col h-full relative block">
        ...
        <div className="text-center"><Link href="/smp/prestasi" className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl border border-emerald-600/50 text-emerald-300 hover:text-emerald-950 hover:bg-amber-400 font-bold transition-all shadow-sm">Lihat Semua Prestasi <span>→</span></Link></div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full text-center">
        ...
        <RevealOnScroll delay={800}><Link href="/smp/pengajar" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-[#052e20] hover:bg-emerald-800 border border-emerald-600/50 text-white font-bold transition-all shadow-lg hover:-translate-y-1">Lihat 30+ Pengajar Lainnya <span>→</span></Link></RevealOnScroll>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { judul: "Lab Komputer & Robotik", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Lab+Komputer" },
            { judul: "Lapangan Olahraga Luas", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Lapangan+Olahraga" },
            { judul: "Aula Pertemuan", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Aula+Pertemuan" },
            { judul: "Perpustakaan Digital", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Perpustakaan" }
          ].map((sarpras, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 150}>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 w-full mb-12">
        <RevealOnScroll delay={100}><h2 className="text-2xl font-bold text-white mb-8 flex items-center gap-3 justify-center md:justify-start"><span className="text-amber-400 text-3xl">💰</span> Estimasi Rincian Biaya SMP</h2></RevealOnScroll>
        <RevealOnScroll delay={200}>
          <div className="bg-[#052e20]/40 backdrop-blur-sm border border-emerald-800/40 rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex justify-between items-center border-b border-emerald-900/50 pb-4"><span className="font-medium">Uang Pangkal / Gedung</span><span className="font-bold text-amber-400 text-lg">Rp 4.000.000</span></div>
              <div className="flex justify-between items-center border-b border-emerald-900/50 pb-4"><span className="font-medium">Seragam (4 Stel)</span><span className="font-bold text-amber-400 text-lg">Rp 750.000</span></div>
              <div className="flex justify-between items-center border-b border-emerald-900/50 pb-4"><span className="font-medium">SPP Bulanan</span><span className="font-bold text-amber-400 text-lg">Rp 300.000 <span className="text-xs text-emerald-100/60">/bulan</span></span></div>
            </div>
            <div className="mt-8 pt-6 border-t border-amber-500/20 text-center relative z-10"><Link href="/pendaftaran/smp" className="inline-block px-8 py-3 rounded-xl bg-amber-400 hover:bg-amber-300 text-emerald-950 font-bold shadow-lg transition-all">Daftar SMP Al-Irsyad Sekarang ✨</Link></div>
          </div>
        </RevealOnScroll>
      </section>
