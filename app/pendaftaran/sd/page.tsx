...
export default function FormPendaftaranSD() {
    ...
    <div className="min-h-screen bg-[#071E16] text-slate-100 font-sans selection:bg-amber-400 selection:text-emerald-950 py-12 px-6">
      ...
      <main className="max-w-3xl mx-auto bg-gradient-to-br from-emerald-900/40 via-[#071E16] to-emerald-950/90 border border-emerald-700/50 rounded-[2.5rem] p-8 sm:p-12 shadow-2xl relative overflow-hidden backdrop-blur-xl">
        ...
        <div className="text-center space-y-3 mb-10 relative z-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-white">Pendaftaran SD Al-Irsyad</h1>
          <p className="text-xs text-emerald-200/70">Silakan isi data calon peserta didik tingkat Sekolah Dasar dengan benar.</p>
        </div>
        ...
        {submitted ? (
          <div className="bg-emerald-950/90 border border-emerald-500/50 rounded-3xl p-8 text-center space-y-4 relative z-10 animate-fade-in">
            ...
            <h3 className="text-2xl font-bold text-white">Pendaftaran SD Berhasil Dikirim!</h3>
            <p className="text-xs text-emerald-200/70 max-w-md mx-auto">Data Anda telah masuk ke panitia SD Al-Irsyad. Tim kami akan segera menghubungi via WhatsApp.</p>
            <div className="pt-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            <div className="space-y-4 bg-emerald-950/40 p-6 rounded-3xl border border-emerald-800/50">
              <h3 className="text-sm font-bold text-amber-300 flex items-center gap-2">
                <User className="w-4 h-4" /> Data Calon Siswa SD
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-emerald-200 mb-1">Nama Lengkap Anak</label>
                  <input required type="text" placeholder="Nama lengkap sesuai akta" className="w-full px-4 py-3 rounded-xl bg-[#071E16] border border-emerald-800 text-white text-xs focus:border-amber-400 focus:outline-none transition" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-emerald-200 mb-1">NISN (Jika Ada)</label>
                  <input type="text" placeholder="Nomor Induk Siswa Nasional" className="w-full px-4 py-3 rounded-xl bg-[#071E16] border border-emerald-800 text-white text-xs focus:border-amber-400 focus:outline-none transition" />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 bg-emerald-950/40 p-6 rounded-3xl border border-emerald-800/50">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div className="space-y-1">
                  ...
                  <input type="file" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx" className="w-full text-xs text-emerald-300 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-emerald-900 file:text-amber-300 hover:file:bg-emerald-800 cursor-pointer" />
                </div>
                <div className="space-y-1">
            ...
            <div className="pt-4 text-center">
              <button type="submit" className="w-full sm:w-auto px-12 py-4 rounded-2xl bg-gradient-to-r from-amber-400 via-amber-300 to-amber-500 text-emerald-950 font-black text-sm shadow-2xl shadow-amber-400/20 hover:scale-105 transition flex items-center justify-center gap-2 mx-auto cursor-pointer">
                <Send className="w-4 h-4" /> Kirim Formulir Pendaftaran SD
              </button>
            </div>
          </form>
        )}
