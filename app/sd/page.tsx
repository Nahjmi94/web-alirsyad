    ...
    <div className="flex flex-col min-h-screen bg-transparent text-slate-100 pb-20 overflow-hidden">
      ...
      <section className="relative pt-12 pb-10 px-6 text-center">
        <RevealOnScroll delay={100}>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 drop-shadow-md tracking-tight">
            SD Al-Irsyad <br /> Pekalongan
          </h1>
          <p className="text-emerald-50 max-w-3xl mx-auto leading-relaxed text-xl sm:text-2xl font-medium">
            Membangun pondasi dasar ilmu pengetahuan, adab Islami, dan pembiasaan ibadah harian untuk mencetak generasi sholeh dan sholehah.
          </p>
        </RevealOnScroll>
      </section>
        ...
        <RevealOnScroll delay={200}>
          <div className="bg-[#071E16]/90 backdrop-blur-md border border-emerald-700/50 rounded-3xl p-8 sm:p-12 shadow-2xl relative flex flex-col md:flex-row gap-8 items-center hover:border-amber-400/40 transition-colors duration-500">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-2">Ustadz Ahmad, S.Pd</h2>
              <p className="text-amber-400 text-lg sm:text-xl font-bold mb-4">- Kepala SD Al-Irsyad -</p>
              <p className="text-emerald-50 leading-relaxed text-lg sm:text-xl font-normal text-justify">
                "Bismillah. Masa Sekolah Dasar adalah masa keemasan untuk menanamkan aqidah dan adab. Di SD Al-Irsyad, kami tidak hanya fokus pada kecerdasan akademik, tetapi juga mengedepankan pendidikan karakter berbasis Al-Qur'an dan Sunnah."
              </p>
            </div>
          </div>
        </RevealOnScroll>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            { judul: "Video Profil", desc: "Mengenal program dan fasilitas unggulan SD.", thumbnail: "https://placehold.co/600x340/0d4738/fbbf24?text=Video+Profil" },
            { judul: "Video Terbaru", desc: "Dokumentasi kegiatan dan event terbaru sekolah.", thumbnail: "https://placehold.co/600x340/0d4738/fbbf24?text=Video+Terbaru" }
          ].map((vid, i) => (
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-10">
          {[
            { id: '1', judul: "Perkemahan Pramuka", desc: "Melatih kemandirian siswa di alam terbuka.", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Kegiatan+SD" },
            { id: '2', judul: "Mabit (Malam Bina Iman)", desc: "Qiyamullail dan muhasabah bersama.", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Kegiatan+SD" },
            { id: '3', judul: "Market Day Cilik", desc: "Belajar kewirausahaan Islami sejak dini.", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Kegiatan+SD" }
          ].map((item, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 200}>
              <Link href={`/sd/kegiatan/${item.id}`} className="group overflow-hidden rounded-3xl border-2 border-emerald-400/50 hover:border-amber-400 hover:-translate-y-2 hover:shadow-[0_10px_30px_-10px_rgba(52,211,153,0.3)] transition-all duration-500 bg-[#0d4738] cursor-pointer flex flex-col h-full block">
        ...
        <div className="text-center">
          <Link href="/sd/kegiatan" className="inline-flex items-center justify-center gap-3 px-10 py-4 rounded-2xl bg-[#0d4738] border-2 border-emerald-400/80 text-emerald-100 hover:text-emerald-950 hover:bg-amber-400 hover:border-amber-400 text-xl font-black transition-all duration-300 shadow-xl">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-10">
          {[
            { id: '1', juara: "Medali Emas Matematika", event: "OSN Tingkat Kota 2026", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Prestasi+SD+1" },
            { id: '2', juara: "Juara 1 Pidato B. Arab", event: "Porseni Pelajar 2026", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Prestasi+SD+2" },
            { id: '3', juara: "Juara 1 Tahfidz Juz 30", event: "Festival Anak Sholeh 2026", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Prestasi+SD+3" }
          ].map((item, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 200}>
              <Link href={`/sd/prestasi/${item.id}`} className="group overflow-hidden rounded-3xl border-2 border-emerald-400/50 hover:border-amber-400 hover:-translate-y-2 hover:shadow-[0_10px_30px_-10px_rgba(251,191,36,0.3)] transition-all duration-500 bg-[#0d4738] cursor-pointer flex flex-col h-full relative block">
        ...
        <div className="text-center">
          <Link href="/sd/prestasi" className="inline-flex items-center justify-center gap-3 px-10 py-4 rounded-2xl bg-[#0d4738] border-2 border-emerald-400/80 text-emerald-100 hover:text-emerald-950 hover:bg-amber-400 hover:border-amber-400 text-xl font-black transition-all duration-300 shadow-xl">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full text-center">
        ...
        <RevealOnScroll delay={800}>
          <Link href="/sd/pengajar" className="inline-flex items-center gap-3 px-10 py-4 rounded-2xl bg-amber-400 hover:bg-amber-300 text-emerald-950 text-xl font-black transition-all duration-300 shadow-xl hover:-translate-y-1">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { judul: "Ruang Kelas Ber-AC", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Ruang+Kelas" },
            { judul: "Lapangan Olahraga", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Lapangan+Olahraga" },
            { judul: "Mushola Representatif", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Mushola" },
            { judul: "Perpustakaan Mini", foto: "https://placehold.co/600x400/0d4738/fbbf24?text=Perpustakaan" }
          ].map((sarpras, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 150}>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 w-full mb-12">
        <RevealOnScroll delay={100}>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-8 flex items-center gap-3 justify-center md:justify-start">
            <span className="text-amber-400 text-4xl">💰</span> Estimasi Rincian Biaya SD
          </h2>
        </RevealOnScroll>
        <RevealOnScroll delay={200}>
          <div className="bg-[#071E16]/90 backdrop-blur-md border border-emerald-700/50 rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-6 relative z-10">
              <div className="flex justify-between items-center border-b border-emerald-800/60 pb-5 hover:text-amber-400 transition-colors group cursor-default">
                ...
                <span className="font-black text-amber-400 text-2xl sm:text-3xl">Rp 3.500.000</span>
              </div>
              <div className="flex justify-between items-center border-b border-emerald-800/60 pb-5 hover:text-amber-400 transition-colors group cursor-default">
                ...
                <span className="font-black text-amber-400 text-2xl sm:text-3xl">Rp 600.000</span>
              </div>
              <div className="flex justify-between items-center border-b border-emerald-800/60 pb-5 hover:text-amber-400 transition-colors group cursor-default">
                ...
                <span className="font-black text-amber-400 text-2xl sm:text-3xl">Rp 250.000 <span className="text-base text-emerald-200/80 font-normal">/bulan</span></span>
              </div>
            </div>
            <div className="mt-10 pt-8 border-t border-amber-500/30 text-center relative z-10">
              <Link href="/pendaftaran/sd" className="inline-block px-10 py-4 rounded-2xl bg-amber-400 hover:bg-amber-300 text-emerald-950 text-xl font-black shadow-lg shadow-amber-400/20 hover:-translate-y-1 transition-all duration-300">
                Daftar SD Al-Irsyad Sekarang ✨
              </Link>
            </div>
          </div>
        </RevealOnScroll>
