    ...
    <div className="flex flex-col min-h-screen bg-[#071E16] text-slate-100 pb-20 overflow-hidden">
      ...
      <section className="relative pt-12 pb-10 px-6 text-center">
        <RevealOnScroll delay={100}>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-bold mb-6 tracking-widest shadow-inner">USIA 7 - 12 TAHUN</div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 drop-shadow-md tracking-tight">SD Al-Irsyad <br /> Pekalongan</h1>
          <p className="text-emerald-100/70 max-w-2xl mx-auto leading-relaxed text-lg font-light">Membangun pondasi dasar ilmu pengetahuan, adab Islami, dan pembiasaan ibadah harian untuk mencetak generasi sholeh dan sholehah.</p>
        </RevealOnScroll>
      </section>
        ...
        <RevealOnScroll delay={200}>
          <div className="bg-[#052e20]/40 backdrop-blur-sm border border-emerald-800/40 rounded-3xl p-8 sm:p-10 shadow-2xl relative flex flex-col md:flex-row gap-8 items-center hover:border-amber-400/30 transition-colors">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-1">Ustadz Ahmad, S.Pd</h2>
              <p className="text-amber-400 text-sm font-medium mb-4">- Kepala SD Al-Irsyad -</p>
              <p className="text-emerald-100/80 leading-relaxed text-sm font-light text-justify">"Bismillah. Masa Sekolah Dasar adalah masa keemasan untuk menanamkan aqidah dan adab. Di SD Al-Irsyad, kami tidak hanya fokus pada kecerdasan akademik, tetapi juga mengedepankan pendidikan karakter berbasis Al-Qur'an dan Sunnah."</p>
            </div>
          </div>
        </RevealOnScroll>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            { judul: "Video Profil", desc: "Mengenal program dan fasilitas unggulan SD.", thumbnail: "https://placehold.co/600x340/041a12/fbbf24?text=Video+Profil" },
            { judul: "Video Terbaru", desc: "Dokumentasi kegiatan dan event terbaru sekolah.", thumbnail: "https://placehold.co/600x340/041a12/fbbf24?text=Video+Terbaru" }
          ].map((vid, i) => (
      ...
      {/* KEGIATAN */}
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        <RevealOnScroll delay={100}><h2 className="text-2xl font-bold text-white mb-8 flex items-center gap-3"><span className="text-amber-400 text-3xl">📸</span> Foto & Artikel Kegiatan</h2></RevealOnScroll>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
          {[
            { id: '1', judul: "Perkemahan Pramuka", desc: "Melatih kemandirian siswa di alam terbuka.", foto: "https://placehold.co/600x400/064e3b/fbbf24?text=Kegiatan+SD" },
            { id: '2', judul: "Mabit (Malam Bina Iman)", desc: "Qiyamullail dan muhasabah bersama.", foto: "https://placehold.co/600x400/064e3b/fbbf24?text=Kegiatan+SD" },
            { id: '3', judul: "Market Day Cilik", desc: "Belajar kewirausahaan Islami sejak dini.", foto: "https://placehold.co/600x400/064e3b/fbbf24?text=Kegiatan+SD" }
          ].map((item, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 200}>
              <Link href={`/sd/kegiatan/${item.id}`} className="group overflow-hidden rounded-3xl border border-emerald-800/50 hover:border-amber-400/50 hover:-translate-y-2 transition-all duration-500 bg-[#041a12] cursor-pointer flex flex-col h-full block">
        ...
        <div className="text-center"><Link href="/sd/kegiatan" className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl border border-emerald-600/50 text-emerald-300 hover:text-emerald-950 hover:bg-amber-400 font-bold transition-all shadow-sm">Lihat Semua Kegiatan <span>→</span></Link></div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
          {[
            { id: '1', juara: "Medali Emas Olimpiade Matematika", event: "OSN Tingkat Kota 2026", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Prestasi+SD+1" },
            { id: '2', juara: "Juara 1 Pidato Bahasa Arab", event: "Porseni Pelajar 2026", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Prestasi+SD+2" },
            { id: '3', juara: "Juara 1 Lomba Tahfidz Juz 29-30", event: "Festival Anak Sholeh 2026", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Prestasi+SD+3" }
          ].map((item, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 200}>
              <Link href={`/sd/prestasi/${item.id}`} className="group overflow-hidden rounded-3xl border border-emerald-800/50 hover:border-amber-400/50 hover:-translate-y-2 transition-all duration-500 bg-[#041a12] cursor-pointer flex flex-col h-full relative block">
        ...
        <div className="text-center"><Link href="/sd/prestasi" className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl border border-emerald-600/50 text-emerald-300 hover:text-emerald-950 hover:bg-amber-400 font-bold transition-all shadow-sm">Lihat Semua Prestasi <span>→</span></Link></div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 w-full text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
           {[
             { nama: "Ustadz Ahmad, S.Pd", peran: "Kepala Sekolah", gender: "M" },
             { nama: "Ustazah Nabila, M.Pd", peran: "Wakasek Kurikulum", gender: "F" },
             { nama: "Ustadz Hasan, S.Ag", peran: "Guru PAI & Tahfidz", gender: "M" }
           ].map((guru, i) => (
             <RevealOnScroll key={i} delay={(i+1) * 200}>
        ...
        <RevealOnScroll delay={800}><Link href="/sd/pengajar" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-[#052e20] hover:bg-emerald-800 border border-emerald-600/50 text-white font-bold transition-all shadow-lg hover:-translate-y-1">Lihat 30+ Pengajar Lainnya <span>→</span></Link></RevealOnScroll>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { ikon: "📖", judul: "Tahfidz & Tahsin", desc: "Target hafalan Al-Qur'an Juz 29 & 30 dengan makhraj yang benar." },
            { ikon: "🤲", judul: "Aqidah & Akhlak", desc: "Pembiasaan ibadah harian, sholat berjamaah, dan adab Islami." },
            { ikon: "🧮", judul: "Akademik & Sains", desc: "Penguatan literasi, numerasi, dan logika sains dasar." },
            { ikon: "🗣️", judul: "Bahasa Arab & Inggris", desc: "Pengenalan kosa kata percakapan dasar secara interaktif." }
          ].map((item, i) => (
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { judul: "Ruang Kelas Ber-AC", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Ruang+Kelas" },
            { judul: "Lapangan Olahraga", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Lapangan+Olahraga" },
            { judul: "Mushola Representatif", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Mushola" },
            { judul: "Perpustakaan Mini", foto: "https://placehold.co/600x400/041a12/fbbf24?text=Perpustakaan" }
          ].map((sarpras, i) => (
            <RevealOnScroll key={i} delay={(i+1) * 150}>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 w-full mb-12">
        <RevealOnScroll delay={100}><h2 className="text-2xl font-bold text-white mb-8 flex items-center gap-3 justify-center md:justify-start"><span className="text-amber-400 text-3xl">💰</span> Estimasi Rincian Biaya SD</h2></RevealOnScroll>
        <RevealOnScroll delay={200}>
          <div className="bg-[#052e20]/40 backdrop-blur-sm border border-emerald-800/40 rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex justify-between items-center border-b border-emerald-900/50 pb-4"><span className="font-medium">Uang Pangkal / Gedung</span><span className="font-bold text-amber-400 text-lg">Rp 3.500.000</span></div>
              <div className="flex justify-between items-center border-b border-emerald-900/50 pb-4"><span className="font-medium">Seragam (4 Stel)</span><span className="font-bold text-amber-400 text-lg">Rp 600.000</span></div>
              <div className="flex justify-between items-center border-b border-emerald-900/50 pb-4"><span className="font-medium">SPP Bulanan</span><span className="font-bold text-amber-400 text-lg">Rp 250.000 <span className="text-xs text-emerald-100/60">/bulan</span></span></div>
            </div>
            <div className="mt-8 pt-6 border-t border-amber-500/20 text-center relative z-10"><Link href="/pendaftaran/sd" className="inline-block px-8 py-3 rounded-xl bg-amber-400 hover:bg-amber-300 text-emerald-950 font-bold shadow-lg transition-all">Daftar SD Al-Irsyad Sekarang ✨</Link></div>
          </div>
        </RevealOnScroll>
      </section>
