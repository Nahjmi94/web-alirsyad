    ...
    <div className="flex flex-col min-h-screen bg-transparent text-slate-100 selection:bg-amber-400 selection:text-emerald-950 overflow-hidden">
      ...
      <section className="relative pt-8 pb-12 px-4 sm:px-6 lg:pt-16 overflow-hidden border-b border-emerald-400/30">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          {/* AREA TEKS DENGAN LATAR HIJAU TUA AGAR JELAS */}
          <div className="text-center lg:text-left bg-[#071E16]/90 p-8 sm:p-10 rounded-3xl border border-emerald-700/50 shadow-2xl backdrop-blur-md">
            <RevealOnScroll delay={100}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-900/60 border border-emerald-500/40 text-emerald-300 text-sm font-medium mb-6 shadow-lg">
            ...
            <RevealOnScroll delay={300}>
              <p className="text-slate-200 text-base sm:text-lg md:text-xl font-light leading-relaxed max-w-2xl mx-auto lg:mx-0">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 relative w-full">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            <RevealOnScroll delay={100}>
              <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3 border-b-2 border-emerald-400/50 pb-3 relative">
                Tulisan Terbaru
            ...
            <div className="space-y-6">
              {[
                ...
                <RevealOnScroll key={i} delay={(i + 1) * 200}>
                  <div className="flex flex-col sm:flex-row gap-5 bg-[#0d4738] border border-emerald-400/50 rounded-xl overflow-hidden hover:border-amber-400/50 hover:shadow-[0_10px_30px_-10px_rgba(255,255,255,0.15)] transition-all duration-300 group cursor-pointer">
                    ...
                    <div className="sm:w-3/5 p-5 flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-emerald-100 mb-4 line-clamp-3 leading-relaxed">{berita.desc}</p>
                      <div className="mt-auto flex justify-between items-center">
                        <span className="text-xs font-medium text-amber-300">{berita.tgl}</span>
                        <div className="w-8 h-8 rounded-lg bg-[#115e4f] flex items-center justify-center group-hover:bg-amber-400 group-hover:text-emerald-950 transition-colors">
          ...
          <div className="lg:col-span-1">
             <RevealOnScroll delay={300}>
                <div className="bg-[#0d4738] border border-emerald-400/50 rounded-2xl p-6 shadow-xl hover:border-amber-400/30 transition-colors duration-500 text-center flex flex-col h-full">
                  <div className="bg-white rounded-[2rem] rounded-tl-sm rounded-br-sm p-6 mb-6 mx-auto w-48 h-48 flex items-center justify-center shadow-inner relative overflow-hidden group border-2 border-emerald-400">
                  ...
                  <p className="text-amber-300 text-sm font-medium mb-6 tracking-wide">
                    - Direktur -
                  </p>
                  <div className="text-emerald-50 text-sm md:text-base font-light text-justify leading-relaxed mb-6 flex-1">
                  ...
                  <button className="w-full py-2.5 rounded-lg border border-emerald-400/80 text-emerald-100 hover:text-emerald-950 hover:bg-amber-400 hover:border-amber-400 transition-all duration-300 text-xs uppercase font-bold tracking-widest">
                    Selengkapnya
                  </button>
                </div>
             </RevealOnScroll>
      ...
      <section id="unit" className="max-w-7xl mx-auto px-6 py-16 relative w-full border-t border-emerald-400/30">
        <div className="text-center mb-12 relative z-10">
          <RevealOnScroll>
            ...
            <p className="text-emerald-100 max-w-2xl mx-auto font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
          <RevealOnScroll delay={100}>
            <a href="/paud" className="group relative bg-[#0d4738] border border-emerald-400/50 rounded-3xl p-6 overflow-hidden hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_10px_40px_-10px_rgba(255,255,255,0.2)] hover:border-amber-400/50 block h-full">
              <div className="w-14 h-14 rounded-2xl bg-[#115e4f] flex items-center justify-center text-3xl mb-6 group-hover:scale-110 group-hover:bg-amber-400/90 transition-all duration-300 shadow-inner">🧸</div>
              <h3 className="text-xl font-bold text-white mb-2 group-hover:text-amber-400 transition-colors">PAUD (KB & TK)</h3>
              <p className="text-sm text-emerald-100 mb-6 line-clamp-3">Membentuk karakter islami sejak dini dengan metode pembelajaran interaktif.</p>
          ...
          <RevealOnScroll delay={200}>
            <a href="/sd" className="group relative bg-[#0d4738] border border-emerald-400/50 rounded-3xl p-6 overflow-hidden hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_10px_40px_-10px_rgba(255,255,255,0.2)] hover:border-amber-400/50 block h-full">
              <div className="w-14 h-14 rounded-2xl bg-[#115e4f] flex items-center justify-center text-3xl mb-6 group-hover:scale-110 group-hover:bg-amber-400/90 transition-all duration-300 shadow-inner">📚</div>
              <h3 className="text-xl font-bold text-white mb-2 group-hover:text-amber-400 transition-colors">SD Al-Irsyad</h3>
              <p className="text-sm text-emerald-100 mb-6 line-clamp-3">Pondasi dasar ilmu pengetahuan dan pembiasaan ibadah harian.</p>
              <span className="text-amber-400 text-sm font-semibold flex items-center gap-1 group-hover:gap-2 transition-all absolute bottom-6">Lihat Detail <span>→</span></span>
            </a>
          </RevealOnScroll>
          <RevealOnScroll delay={300}>
            <a href="/smp" className="group relative bg-[#0d4738] border border-emerald-400/50 rounded-3xl p-6 overflow-hidden hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_10px_40px_-10px_rgba(255,255,255,0.2)] hover:border-amber-400/50 block h-full">
              <div className="w-14 h-14 rounded-2xl bg-[#115e4f] flex items-center justify-center text-3xl mb-6 group-hover:scale-110 group-hover:bg-amber-400/90 transition-all duration-300 shadow-inner">🔬</div>
              <h3 className="text-xl font-bold text-white mb-2 group-hover:text-amber-400 transition-colors">SMP Al-Irsyad</h3>
              <p className="text-sm text-emerald-100 mb-6 line-clamp-3">Pengembangan potensi remaja sejalan dengan aqidah lurus dan kuat.</p>
              <span className="text-amber-400 text-sm font-semibold flex items-center gap-1 group-hover:gap-2 transition-all absolute bottom-6">Lihat Detail <span>→</span></span>
            </a>
          </RevealOnScroll>
          <RevealOnScroll delay={400}>
            <a href="/sma" className="group relative bg-[#0d4738] border border-emerald-400/50 rounded-3xl p-6 overflow-hidden hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_10px_40px_-10px_rgba(255,255,255,0.2)] hover:border-amber-400/50 block h-full">
              <div className="w-14 h-14 rounded-2xl bg-[#115e4f] flex items-center justify-center text-3xl mb-6 group-hover:scale-110 group-hover:bg-amber-400/90 transition-all duration-300 shadow-inner">🎓</div>
              <h3 className="text-xl font-bold text-white mb-2 group-hover:text-amber-400 transition-colors">SMA Al-Irsyad</h3>
              <p className="text-sm text-emerald-100 mb-6 line-clamp-3">Mempersiapkan calon pemimpin masa depan yang berwawasan global.</p>
              <span className="text-amber-400 text-sm font-semibold flex items-center gap-1 group-hover:gap-2 transition-all absolute bottom-6">Lihat Detail <span>→</span></span>
            </a>
          </RevealOnScroll>
        </div>
      ...
      <section id="karir" className="max-w-7xl mx-auto px-6 py-16 relative w-full border-t border-emerald-400/30">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <RevealOnScroll delay={100}>
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#0d4738] border border-emerald-400/50 text-emerald-100 text-xs font-bold mb-4">
                💼 Info Loker
              </div>
              <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
              ...
              <a 
                ...
                className="inline-block px-6 py-2.5 rounded-xl bg-amber-400 hover:bg-amber-300 border border-amber-500 text-emerald-950 font-extrabold transition-all shadow-lg hover:-translate-y-1"
              >
          ...
          <div className="h-full">
            {dataLoker.length > 0 ? (
              <div className="space-y-4">
                {dataLoker.map((loker, i) => (
                  <RevealOnScroll key={i} delay={(i+2) * 150}>
                    <div className="bg-[#0d4738] border border-emerald-400/50 p-5 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-amber-400/50 transition-colors group">
                        <div>
                          <h4 className="font-bold text-white group-hover:text-amber-400 transition-colors">{loker.posisi}</h4>
                          <p className="text-xs text-emerald-100 mt-1">{loker.syarat}</p>
                        </div>
                        <a 
                          href={linkGoogleForm}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-5 py-2 text-xs font-bold bg-[#115e4f] text-emerald-100 rounded-lg group-hover:bg-amber-400 group-hover:text-emerald-950 transition-colors"
                        >
                          Detail
                        </a>
                    </div>
              ...
              <RevealOnScroll delay={200}>
                <div className="bg-[#0d4738] border-2 border-dashed border-emerald-400/50 p-8 rounded-2xl flex flex-col items-center justify-center text-center h-full min-h-[250px]">
                  <div className="w-16 h-16 bg-[#115e4f] rounded-full flex items-center justify-center mb-4">
                    <span className="text-2xl grayscale opacity-90">📭</span>
                  </div>
      ...
      <section id="qna" className="max-w-4xl mx-auto px-6 py-16 relative w-full border-t border-emerald-400/30">
        ...
        <div className="space-y-5 relative z-10">
          <RevealOnScroll delay={100}>
            <div className="group bg-[#0d4738] border border-emerald-400/50 p-6 rounded-2xl cursor-pointer transition-all duration-500 hover:-translate-y-1 hover:border-amber-400/50 shadow-md">
              ...
              <p className="text-emerald-100 font-light text-sm md:text-base leading-relaxed">
                Pilih menu <strong className="text-white font-medium">Formulir PPDB</strong> di atas, lalu klik jenjang yang diinginkan untuk mengakses halaman pendaftaran online maupun info pendaftaran offline.
              </p>
            </div>
          </RevealOnScroll>
        </div>
      ...
      <footer className="w-full bg-gradient-to-b from-[#115e4f] to-[#093026] border-t border-emerald-400/60 pt-10 pb-6 mt-auto relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="border-t border-emerald-500/60 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
            <p className="text-emerald-100 text-xs font-medium">© 2026 Direktorat Pendidikan Al-Irsyad Pekalongan. All Rights Reserved.</p>
            <div className="text-amber-400 text-xs font-bold tracking-widest uppercase">Cetak Generasi Unggul ✨</div>
          </div>
        </div>
      </footer>
    </div>
